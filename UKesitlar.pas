...
begin
  Case StrToInt(FData.TDONEM.FieldByName('Ay').AsString) of
    ...
    4:
      ayy := FData.UniAcilisCalYilname.value + ' NÝSAN';
    5:
      ayy := FData.UniAcilisCalYilname.value + ' MAYIS';
    6:
      ayy := FData.UniAcilisCalYilname.value + ' HAZÝRAN';
    7:
      ayy := FData.UniAcilisCalYilname.value + ' TEMMUZ';
    8:
      ayy := FData.UniAcilisCalYilname.value + ' AÐUSTOS';
    9:
      ayy := FData.UniAcilisCalYilname.value + ' EYLÜL';
    10:
      ayy := FData.UniAcilisCalYilname.value + ' EKÝM';
    11:
...
begin
  Case RadioGroup1.ItemIndex of
    ...
    // RadioGroup1.Items.Add('Isz. Sig Iþv ');
    15:
      begin
        Query2.SQL.Clear;
        Query2.SQL.Add
