...
uses
  ...
  Grids, DBGrids,  frxDBSet,  Uni, MemDS, DBAccess, frxClass, cxGraphics,
...
type
  TFKazanlar = class(TForm)
    ...
    ViewKazanc: TcxGridDBTableView;
    LevelKazanc: TcxGridLevel;
    GridKazanc: TcxGrid;
    ViewSira: TcxGridDBColumn;
    ViewSicil: TcxGridDBColumn;
    ViewAdi: TcxGridDBColumn;
    ViewTutar: TcxGridDBColumn;
    Panel3: TPanel;
    Label3: TLabel;
    Label4: TLabel;
    Label1: TLabel;
