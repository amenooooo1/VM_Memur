...
begin
  j := 0;
  If MessageDlg('Kidem Ayý Artacakmý ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes
  then j := 1;
  Query2.Open;
  ...
  Label3.Caption := FData.TDONEM.FieldByName('Ay').AsString + ' ' +
    FData.TDONEM.FieldByName('Donem').AsString + ' Sicil Taþýndý';
