...
begin
  If MessageDlg('Bütçe Emanetine Alacakmýsýnýz ?', mtConfirmation,
...
begin
  para := qtah;
  QRTahpara.Caption := 'Yalnýz: ' + yazdir(currtostr(para)) +
    '  Lira tamamen ve nakten aldým';
  para := qode;
  QROdepara.Caption := 'Yalnýz: ' + yazdir(currtostr(para)) +
    '  Lira tamamen ve nakten aldým';
end;
...
begin
  ...
  If UniQM1Onay.AsString = 'E' then ShowMessage('Bu Maaþ Muhasebeleþtirilmiþ')
  else
  begin
    UniQM2.First;
  ...
  UniQM2.Close;
  ShowMessage('Ýþlem Tamamlanmýþtýr');
end;
