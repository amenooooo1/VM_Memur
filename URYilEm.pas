...
Begin
  i:=i +1;
  FData.TSSKDORT.Insert;
  FData.TSSKDORT.FieldByName('Sira').value:=i;
 end;
FData.TSSKDORT.IndexFieldNames:='Sira';
end;

procedure TFRYilEm.sil;
begin
FData.TSSKDORT.Close;
//FData.TSSKDORT.Exclusive:=True;
FData.TSSKDORT.Open;
//FData.TSSKDORT.EmptyTable;
FData.TSSKDORT.Close;
//FData.TSSKDORT.Exclusive:=False;
FData.TSSKDORT.Open;
End;
...
begin
//FData.TSSKDORT.IndexFieldNames:='sicno';
FData.TSSKDORT.Open;
Table1.Open;
Query1.Open;
HAZ;
...
procedure TFRYilEm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QrLabel1.Caption :=(FData.UniAcilisCalYil.FieldByName('name').Value)+
' YILINA AÝT ÞAHIS EMEKLÝLÝK KESENEKLERÝ ÝCMAL BORDROSU';
QrLabel24.Caption :=(FData.UniSistem.FieldByName('Kurum').Value)+
' BAÞKANLIÐI';
QrLabel26.Caption :=(FData.UniSistem.FieldByName('Ilce').Value)+' / '+
(FData.UniSistem.FieldByName('Il').Value);
QrLabel28.Caption :=FData.UniSistem.FieldByName('Kurum').Value;
end;
...
QrLabel95.Caption :=(FData.UniSistem.FieldByName('Ilce').Value)+' / '+
(FData.UniSistem.FieldByName('Il').Value);
QrLabel96.Caption :=(FData.UniSistem.FieldByName('Ilce').Value)+' / '+
(FData.UniSistem.FieldByName('Il').Value);
QuickRep2.Preview;
end;
