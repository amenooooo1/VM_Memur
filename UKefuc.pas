...
begin
  ...
  Table1.FieldByName('Göv').Value:=Query1.FieldByName('Unvan').Value;
...
begin
QRLabel18.Caption:='Devresi '+ FData.UniAcilisCalYil.FieldByName('name').value+' üç aylýk';
s:= (i div 17);
