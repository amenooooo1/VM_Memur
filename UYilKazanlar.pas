...
uses
  ...
  Grids, DBGrids, Uni, MemDS, DBAccess, frxClass, frxDBSet, cxGraphics,
  cxControls, cxLookAndFeels, cxLookAndFeelPainters, cxStyles, dxSkinsCore,
  dxSkinBlueprint, dxSkinDevExpressDarkStyle, dxSkinDevExpressStyle,
  dxSkinHighContrast, dxSkinLilian, dxSkinSevenClassic, dxSkinSharpPlus,
...
type
  TFYilKazanlar = class(TForm)
    ...
    ViewRapr: TcxGridDBTableView;
    LevelRapor: TcxGridLevel;
    GridRapor: TcxGrid;
    ViewRaprAy: TcxGridDBColumn;
    ViewRaprDonem: TcxGridDBColumn;
    ViewRaprSicno: TcxGridDBColumn;
    ViewRaprAdi: TcxGridDBColumn;
    ViewRaprSoyadi: TcxGridDBColumn;
    ViewRaprTutar: TcxGridDBColumn;
