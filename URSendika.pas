...
begin
 Case  StrToInt(Edit2.Text)  of
    ...
    4:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' NÝSAN';
    5:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' MAYIS';
    6:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' HAZÝRAN';
    7:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' TEMMUZ';
    8:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' AÐUSTOS';
    9:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' EYLÜL';
    10:ayy:=FData.UniAcilisCalYil.FieldByName('name').value+' EKÝM';
...
//QuickRep1.Preview ;
   ...
   (frxReport1.FindObject('memo18') as TfrxMemoView).Text:=UniQSendikaAciklama.Value;
...
Query2.ParamByName('t').Asstring:=UniQSendika.Fields[0].Value;
