...
type
  TFAyEmek = class(TForm)
    ...
    Query1Kaz7: TIntegerField;
    Query1Kaz8: TIntegerField;
    Query1Kaz9: TIntegerField;
...
// Table1SskMat.Value:=Query1.FieldByName('sskmat').Value;
 ...
 Table1Der2.Value:=Query1Kaz7.Value;
 Table1Kad2.Value:=Query1Kaz8.Value;
 Table1Ekgos2.Value:=Query1Kaz9.Value;
